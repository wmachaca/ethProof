...
contract SimpleVerifierTest is Test {
  ...
  function test_01_ExactHashChainValidation() public view {
  ...
  function test_02_RLPDecodingValidation() public view {
  ...
  function test_03_IsolateMerkleTrieFailure() public view {
    ...
    try this.testMerkleTrieGet(accountKey, realAccountProof, REAL_STATE_ROOT) returns (
      bytes memory result
    ) {
  ...
  function test_04_TestWithCorrectStateRoot() public view {
    ...
    if (correctStateRoot == REAL_STATE_ROOT) {
      ...
      try this.testMerkleTrieGet(accountKey, realAccountProof, correctStateRoot) returns (
        bytes memory result
      ) {
  ...
  function test_06_GenerateCorrectCommand() public view {
  ...
  function test_07_DirectStorageVerification() public view {
  ...
  // FINAL SUMMARY
  function test_08_FinalSummaryAndSolution() public view {
